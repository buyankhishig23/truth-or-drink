...
export default function QuestionCard({ question, onNext, onBack, onDrink }) {
  ...
  return (
    <div
      className={`bg-white/20 backdrop-blur-md p-8 md:p-12 rounded-3xl shadow-2xl max-w-lg mx-auto text-center border border-white/20 transform transition-transform duration-700 ${
    ...
    >
      <h2
        ...
        style={{ textShadow: "0 0 4px #ffffff, 0 0 8px #ffffff" }}
      >
        {question}
      </h2>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
        ...
        <button
          onClick={onDrink}
          className="bg-blue-600 text-white font-extrabold px-16 md:px-24 py-6 md:py-8 rounded-3xl shadow-md transform transition-all duration-300 hover:scale-101 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
        >
          Уух
        </button>
        ...
        <button
          ...
          style={{ boxShadow: "0 0 4px #bbb, 0 0 8px #ddd" }}
        >
          Буцах
        </button>
      </div>
